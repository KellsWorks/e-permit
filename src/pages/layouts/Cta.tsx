            ...
            <section  id="contact-us" className="text-gray-600 body-font relative">
                ...
                <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    ...
                    <form onSubmit={(e) => {
                        ...
                        name="name" 
                        required
                        className="w-full focus:border-green-500 bg-white rounded-sm border border-gray-300 focus:ring-0 text-sm outline-none text-gray-700 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
                    </div>
                    ...
                    <p className="text-xs text-gray-500 mb-3">By submitting, you agree to our <b className="underline text-green-500">terms of service</b></p>
